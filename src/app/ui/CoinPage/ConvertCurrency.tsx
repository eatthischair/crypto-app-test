...
export const ConvertCurrency = ({
  ...
  return (
    // <div className="flex flex-grow-1 justify-center items-center gap-12 p-4 sm:p-8 text-lg h-[30%] ">
    //   <div className="relative flex items-center bg-[var(--card)] rounded-sm sm:max-w-[30%] py-2">
    //     <span className="pl-4 ml-0 mr-0 pr-2">{symbolArr[0]}</span>
    //     <Input
    //       placeholder="1.00"
    //       className="w-full text-sm sm:text-xl border-none"
    ...
    //     <Input
    //       disabled
    //       className="w-full text-sm sm:text-xl border-none disabled:opacity-100"
