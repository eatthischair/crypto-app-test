...
export const NavBar = () => {
  ...
  return (
    <div className="w-full max-w-[1400px] lg:m-auto min-h-[20%] grid grid-cols-1 gap-3 p-2 sm:grid-cols-[auto_auto_auto_1fr_2fr_auto_auto] sm:gap-4 sm:p-0 sm:min-h-[20%] sm:items-center">
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[var(--background)] shadow-lg border-t border-gray-200 dark:border-gray-700 opacity-100 z-10">
