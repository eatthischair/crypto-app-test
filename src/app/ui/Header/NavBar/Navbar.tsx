...
export const NavBar = () => {
  ...
  return (
    <div className=" w-full max-w-[1400px] lg:m-auto min-h-[20%] grid grid-cols-1 gap-3 sm:grid-cols-[auto_auto_auto_1fr_2fr_auto_auto] sm:gap-4 sm:p-0 sm:min-h-[20%] sm:items-center sm:pt-4">
