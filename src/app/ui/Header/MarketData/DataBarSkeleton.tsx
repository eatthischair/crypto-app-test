...
export function DataBarSkeleton() {
  return (
    <>
      <Skeleton className="max-w-screen min-w-[200vh] flex my-4 items-center justify-center gap-2 border-y sm:py-0 sm:gap-12 text-xs z-0 dark:bg-[var(--card)] sm:-mt-12 sm:-ml-12 max-h-[50px] h-[3rem] sm:h-full">
