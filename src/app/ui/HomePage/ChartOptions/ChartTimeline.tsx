  ...
  return (
    <>
      {timelineArr.map((option, index) => (
        <Button
          key={option}
          className={`flex-grow h-full text-[var(--foreground)] rounded-sm bg-opacity-0 dark:hover:bg-gradient-to-b from-indigo-700 to-indigo-800 hover:bg-gradient-to-b from-indigo-400 to-indigo-500 mx-1 ${
