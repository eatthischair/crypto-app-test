      ...
      <Carousel>
        <CarouselContent>
          {coins.map((coin, index) => (
            <CarouselItem
              key={coin.name}
              className={` flex flex-row sm:grid grid-cols-[50%_50%] sm:grid-cols-[20%_80%] rounded-sm mx-1 max-h-[15vh] h-full bg-[var(--background)] hover:bg-indigo-600 sm:basis-1/6 basis-1/3 text-nowrap overflow-hidden border-2 items-center justify-evenly
